...
void app_main(void)
{
    ...
    do { do { if ((CONFIG_LOG_MAXIMUM_LEVEL >= ((ESP_LOG_INFO) & ((1 << (3)) - 1)))) { ESP_LOG_LEVEL(ESP_LOG_INFO, TAG, "Started timers, time since boot: %lld us",esp_timer_get_time()); } } while(0); } while(0);
